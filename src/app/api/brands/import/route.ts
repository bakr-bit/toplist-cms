...
const importBrandSchema = z.object({
  ...
  cryptoCasino: z.boolean().optional(),
  vpnAllowed: z.boolean().optional(),
      ...
      try {
        ...
        await prisma.brand.create({
          data: {
            ...
            cryptoCasino: data.cryptoCasino ?? null,
            vpnAllowed: data.vpnAllowed ?? null,
            kycRequired: data.kycRequired ?? null,
